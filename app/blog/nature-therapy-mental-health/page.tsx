...
import { natureTherapyContent } from "@/lib/blog-content/nature-therapy";
import DownloadButtons from "@/components/DownloadButtons";

export default function NatureTherapyPost() {
  const { language } = useLanguage();
  const content = natureTherapyContent[language];

  return (
    <article className="relative overflow-hidden">
      <div className="absolute inset-0">
        <div className="absolute top-20 right-20 w-96 h-96 bg-emerald-500/10 rounded-full blur-[150px]"></div>
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <header className="mb-12">
          <div className="mb-6">
            <span className="inline-block bg-gradient-to-r from-emerald-500/20 to-teal-500/20 backdrop-blur-sm px-6 py-2 rounded-full text-sm font-bold text-emerald-300 border border-emerald-500/30">
              {content.category}
            </span>
          </div>
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <div className="bg-gradient-to-br from-emerald-500/10 to-teal-500/10 backdrop-blur-xl rounded-3xl p-8 md:p-12 border border-emerald-500/20 mb-8">
        ...
        <div className="mt-16 bg-gradient-to-br from-emerald-500/10 to-teal-500/10 backdrop-blur-xl rounded-3xl p-10 border border-emerald-500/30 text-center">
