...
import { selfCareRoutineContent } from "@/lib/blog-content/self-care-routine";
import DownloadButtons from "@/components/DownloadButtons";

export default function SelfCareRoutinePost() {
  const { language } = useLanguage();
  const content = selfCareRoutineContent[language];
    ...
    <article className="relative overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <div className="bg-gradient-to-br from-pink-500/10 to-rose-500/10 backdrop-blur-xl rounded-3xl p-8 md:p-12 border border-pink-500/20 mb-8">
          ...
          <div className="space-y-8">
            {content.content.techniques.map((technique: any, index: number) => (
              <div key={index} className="bg-gradient-to-br from-rose-500/10 to-transparent backdrop-blur-xl rounded-2xl p-8 border border-rose-500/20">
                <h3 className="text-2xl font-bold text-pink-300 mb-4">{technique.title}</h3>
          ...
          <div className="bg-gradient-to-br from-pink-500/20 to-rose-500/20 backdrop-blur-xl rounded-3xl p-8 md:p-12 border border-pink-500/30 mt-12">
        ...
        <div className="mt-16 bg-gradient-to-br from-pink-500/10 to-rose-500/10 backdrop-blur-xl rounded-3xl p-10 border border-pink-500/30 text-center">
