...
import { anxietyManagementContent } from "@/lib/blog-content/anxiety-management";
import DownloadButtons from "@/components/DownloadButtons";

export default function AnxietyManagementPost() {
  const { language } = useLanguage();
  const content = anxietyManagementContent[language];
