...
import { buildingHealthyHabitsContent } from "@/lib/blog-content/building-healthy-habits";
import DownloadButtons from "@/components/DownloadButtons";

export default function BuildingHealthyHabitsPost() {
  const { language } = useLanguage();
  const content = buildingHealthyHabitsContent[language];

  return (
    <article className="relative overflow-hidden">
      <div className="absolute inset-0">
        <div className="absolute top-20 right-20 w-96 h-96 bg-lime-500/10 rounded-full blur-[150px]"></div>
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <header className="mb-12">
          <div className="mb-6">
            <span className="inline-block bg-gradient-to-r from-lime-500/20 to-teal-500/20 backdrop-blur-sm px-6 py-2 rounded-full text-sm font-bold text-lime-300 border border-lime-500/30">
              {content.category}
            </span>
          </div>
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <div className="bg-gradient-to-br from-lime-500/10 to-teal-500/10 backdrop-blur-xl rounded-3xl p-8 md:p-12 border border-lime-500/20 mb-8">
          ...
          <div className="space-y-8">
            {content.content.techniques.map((technique: any, index: number) => (
              <div key={index} className="bg-gradient-to-br from-teal-500/10 to-transparent backdrop-blur-xl rounded-2xl p-8 border border-teal-500/20">
                <h3 className="text-2xl font-bold text-lime-300 mb-4">{technique.title}</h3>
          ...
          <div className="bg-gradient-to-br from-lime-500/20 to-teal-500/20 backdrop-blur-xl rounded-3xl p-8 md:p-12 border border-lime-500/30 mt-12">
        ...
        <div className="mt-16 bg-gradient-to-br from-lime-500/10 to-teal-500/10 backdrop-blur-xl rounded-3xl p-10 border border-lime-500/30 text-center">
